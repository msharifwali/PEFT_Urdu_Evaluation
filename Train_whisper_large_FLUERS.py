...
training_args = Seq2SeqTrainingArguments(
    output_dir="./Output_Train_Fluers_Large",  # REPO: its actually pointing the whisper small pretrained model
    per_device_train_batch_size=1,  #changed from 8
