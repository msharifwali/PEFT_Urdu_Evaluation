...
dataset_name = "/data3/sharif/Datasets/Fluers_Urdu_Data" #FLUERs
print("Load the Dataset::  ", dataset_name)

eval_batch_size= 1 #44

print("====================== 🧠 Feat,Tokenize, Pro 🧠 =============================")
