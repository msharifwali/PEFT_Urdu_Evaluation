...
if torch.cuda.is_available() :
  os.environ["CUDA_VISIBLE_DEVICES"] = "1,2,3" #it was prviously the 0 for one GPU 
  print('yes')
...
# dataset_name = "/data3/sharif/Datasets/cv-corpus-13.0-2023-03-09-ur/cv-corpus-13.0-2023-03-09/ur"
# dataset_name = "/data3/sharif/Datasets/cv-corpus-9.0-2022-04-27/ur/"   #CV-Urdu_version_9
dataset_name = "/data3/sharif/Datasets/Urdu_Kathbath_Data/ur"
print("Load the Dataset::  ", dataset_name)
eval_batch_size= 1 #44
#Model=================================================================== 
#==============**** tiny  base  small  medium  large ****================
#========================================================================
#path ="hajar817/whisper-base-urdu"
# path ="./whisper-LARGE-urdu_CV-19/checkpoint-6000/" # its actually pointing the whisper small pretrained model
# path = "/data3/sharif/Datasets/openai_whisper_tiny" 
# path = "/data3/sharif/Datasets/openaiwhisper-small"
# path = "/data3/sharif/Datasets/openai_whisper_base"
path = "/data3/sharif/Datasets/openai_whisper-medium"
# path = "/data3/sharif/Datasets/openai_whisper-large-v3"   #whisper_large
...
common_voice["test"] = load_dataset("csv", data_files={"test": "/data3/sharif/Datasets/Urdu_Kathbath_Data/ur/test.tsv"}, delimiter="\t")["test"]
...
print(f"Test -set Length:  {len(common_voice['test'])}")
print("Before preprocessing:",common_voice['test']['sentence'][120]) 
# common_voice = preprocess_dataset(common_voice) # Pass the dataset to preprocessing functions #added
print("After preprocessing :",common_voice['test']['sentence'][120]) 
...
eval_dataloader = DataLoader(common_voice['test'], batch_size=eval_batch_size, collate_fn=data_collator, shuffle=False)  # HrbK
model.to(device)
model.eval()
...
print(task +" "+ language +"Finetuning the whisper : " +model_name_or_path)
